...
author: "Jonathan Peelle • <http://jonathanpeelle.net>"
date: "January 2016"
output: pdf_document
---
...
I obtained data on speakers from PDFs of previous meeting programs, downloaded from <http://www.neurolang.org/previous/> on October 19, 2015.
...
I manually went through the first three volumes from 2015 of *Brian and Language* on the [ScienceDirect website](http://www.sciencedirect.com/science/journal/0093934X/). I entered basic article and author data in `author_data.tsv`. I included all types of original research articles, but not errata. Again, I assigned gender based on likelihood given authors' first names or photos found on academic websites.


Code
----

All of the relevant R code is included, meaning you should be able to paste in to an R console and recreate the numbers and plots. You can view the Rmarkdown source (`SNLspeakers.Rmd`) for a plain-text version.
...
Between 2009-2015 SNL has had 47 total speakers, of whom 14 (30%) have been female. No year has had more than 38% female speakers.
...
For the first 7 years SNL has had an average 70/30 balance of male-to-female speakers. At first glance this 70/30 split does not appear to reflect the overall distribution of scientists in the field, which *Brain and Language* authors suggest is closer to 50% female.

Although the primary aim of this document is to be descriptive rather than prescriptive, a few useful articles and blog posts on speaker diversity may help provide some additional context or suggestions on acheiving a more balanced set of conference speakers:
...
One possible goal in conference organizing is to ensure approximately equal numbers of male and female speakers. Given that so far SNL has had 70% male speakers for the first 7 years, if our goal were to have approximately equal numbers of male and female speakers overall, we should aim for 70% female speakers for the next 7 years (through SNL in 2022).

(If that 70% number sounds odd to you, it did to me also. But it did **not** seem nearly as odd to me as an attendee for most of the past 7 conferences when we had 70% male speakers. That mismatch is unconscious gender bias in a nutshell.)
